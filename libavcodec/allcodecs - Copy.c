...
#endif
#if CONFIG_ALIAS_PIX_ENCODER && CONFIG_ALIAS_PIX_DECODER
	REGISTER_ENCDEC(ALIAS_PIX, alias_pix);
#endif
#if CONFIG_AMV_ENCODER && CONFIG_AMV_DECODER
...
#endif
#if CONFIG_ASV1_ENCODER && CONFIG_ASV1_DECODER
	REGISTER_ENCDEC(ASV1, asv1);
#endif
#if CONFIG_ASV2_ENCODER && CONFIG_ASV2_DECODER
...
#endif
#if CONFIG_AVRP_ENCODER && CONFIG_AVRP_DECODER
...
#endif
#if CONFIG_AVUI_ENCODER && CONFIG_AVUI_DECODER
	REGISTER_ENCDEC(AVUI, avui);
#endif
#if CONFIG_AYUV_ENCODER && CONFIG_AYUV_DECODER
...
#endif
#if CONFIG_BMP_ENCODER && CONFIG_BMP_DECODER
...
#endif
#if CONFIG_CINEPAK_ENCODER && CONFIG_CINEPAK_DECODER
	REGISTER_ENCDEC(CINEPAK, cinepak);
#endif
#if CONFIG_CLJR_ENCODER & CONFIG_CLJR_DECODER
	REGISTER_ENCDEC(CLJR, cljr);
#endif
#if CONFIG_CLLC_DECODER
	REGISTER_DECODER(CLLC, cllc);
#endif
#if CONFIG_COMFORTNOISE_ENCODER && CONFIG_COMFORTNOISE_DECODER
...
#endif
#if CONFIG_DNXHD_ENCODER && CONFIG_DNXHD_DECODER
	REGISTER_ENCDEC(DNXHD, dnxhd);
#endif
#if CONFIG_DPX_ENCODER && CONFIG_DPX_DECODER
	REGISTER_ENCDEC(DPX, dpx);
#endif
#if CONFIG_DSICINVIDEO_DECODER
	REGISTER_DECODER(DSICINVIDEO, dsicinvideo);
#endif
#if CONFIG_DVVIDEO_ENCODER && CONFIG_DVVIDEO_DECODER
